...
namespace
{
  #include "DiffuseUVVertexShader.inc"
  #include "DiffuseUVEnvVertexShader.inc"
  #include "DiffuseUVCubeVertexShader.inc"
  #include "DiffuseUVEnvCubeVertexShader.inc"
  #include "DiffuseNormalEnvCubeVertexShader.inc"
  #include "UVNormalEnvVertexShader.inc"
}
